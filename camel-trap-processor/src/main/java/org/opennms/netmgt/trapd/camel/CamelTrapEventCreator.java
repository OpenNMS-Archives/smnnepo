...
/**
 */
public class CamelTrapEventCreator implements TrapProcessor {
	
	private static final Logger LOG = LoggerFactory.getLogger(CamelTrapEventCreator.class);
    
    private final EventBuilder m_eventBuilder;
    //private final TrapdIpMgr m_trapdIpMgr;

    
    public CamelTrapEventCreator(/*TrapdIpMgr trapdIpMgr*/) {
