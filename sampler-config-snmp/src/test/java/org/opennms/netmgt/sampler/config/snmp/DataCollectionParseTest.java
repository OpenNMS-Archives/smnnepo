...
public class DataCollectionParseTest {
    ...
    public void testDataCollectionUnmarshall() throws JAXBException, SAXException, IOException {
        ...
        IGroupReference mib2GroupRef = snmpCollection.getIncludedGroups()[0];
        assertNotNull(mib2GroupRef);
        assertEquals("MIB2", mib2GroupRef.getDataCollectionGroup());


        IGroupReference netSnmpGroupRef = snmpCollection.getIncludedGroups()[1];
    ...
    public void testDataCollectionGroups() throws JAXBException {
        ...
        IResourceType resourceType = group.getResourceTypes()[0];
        ...
        ITable table = group.getTables()[0];
        assertNotNull(table);
        ...
        ISystemDef systemDef = group.getSystemDefs()[0];
    ...
    private void assertColumnEq(String oid, String alias, String type, IColumn column) {
    ...
    private void assertMibObjectEq(String oid, String instance, String alias, String type, IMibObject mibObject) {
