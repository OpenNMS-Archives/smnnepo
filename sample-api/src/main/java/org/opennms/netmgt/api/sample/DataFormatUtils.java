...
public abstract class DataFormatUtils {
    public static JaxbDataFormat jaxbXml() {
        try {
            final JAXBContext context = JAXBContext.newInstance(CollectdConfiguration.class, AgentList.class, Agent.class, SnmpConfig.class, SampleSet.class, JmxDatacollectionConfig.class);
